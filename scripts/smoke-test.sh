...
main() {
  ...
  check_health "gateway" "http://localhost:8080/healthz"
  check_health "iam" "http://localhost:8081/healthz"
  check_health "workflow" "http://localhost:8083/healthz"
  check_health "audit" "http://localhost:8084/healthz"
  check_health "cyber" "http://localhost:8085/healthz"
  check_health "data" "http://localhost:8086/healthz"
  check_health "acta" "http://localhost:8087/healthz"
  check_health "lex" "http://localhost:8088/healthz"
  check_health "visus" "http://localhost:8089/healthz"
  check_health "notification" "http://localhost:8090/healthz"
  check_health "file" "http://localhost:8091/healthz"
